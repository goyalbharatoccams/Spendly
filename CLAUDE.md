...
- Page-specific styles → use `style.css` file, not inline `<style>` tags and not internal `<style>` tags
...
| `GET/POST /expenses/<id>/edit` | Implemented — renders `edit_expense.html` |
| `POST /expenses/<id>/delete` | Implemented — Step 6 |
